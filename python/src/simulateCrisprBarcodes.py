...
parser.add_argument("--num_cassettes", type=int, default=10, help="Number of cassettes")
parser.add_argument("--cassette_size", type=int, default=3, help="Number of barcode sites in each cassette")
...
num_cassettes = args.num_cassettes
cassette_size = args.cassette_size
...
lt_sim = cas.sim.Cas9LineageTracingDataSimulator(
    ...
    size_of_cassette=cassette_size,
