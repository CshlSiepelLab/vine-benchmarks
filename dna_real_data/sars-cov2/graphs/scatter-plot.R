...
vine_file  <- if (length(args) >= 1) args[1] else "vine-small.dist"
beast_file <- if (length(args) >= 2) args[2] else "beast-small.dist"
out_file   <- if (length(args) >= 3) args[3] else "scatter.pdf"
